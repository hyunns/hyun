(function() {
    ...
    port.fromTo('.swiper-slide .detail_page', {y: '20px', autoAlpha: 0}, {y: 0, autoAlpha:1, duration: 1,},4)
    port.to('.swiper-slide .line_grow', {width:'100%', left: 0, duration: 1},'-=1')
    port.fromTo('.swiper-slide .txt_wrap *', {y: '50px', autoAlpha: 0,},{duration:1, y: 0, autoAlpha:1, stagger:0.15},4)
})();